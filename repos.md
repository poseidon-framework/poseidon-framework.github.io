...
2. Under [http://c107-224.cloud.gwdg.de:3000/zip_file/\<package_name\>](http://c107-224.cloud.gwdg.de:3000/zip_file/<package_name>), a zip-file for the given package can be downloaded, which contains the package content.
